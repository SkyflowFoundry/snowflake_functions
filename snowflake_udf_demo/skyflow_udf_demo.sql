...
CALL SKYFLOW_TOKENIZE_TABLE('MySkyflowVault', 'CUSTOMERS', 'CUSTOMER_ID', 'NAME,EMAIL,PHONE,ADDRESS', 'sam@skyflow.com');
CALL SKYFLOW_TOKENIZE_TABLE('MySkyflowVault', 'SUPPLIERS', 'SUPPLIER_ID', 'CONTACT_PHONE,CONTACT_EMAIL,CONTACT_ADDRESS', 'sam@skyflow.com');
